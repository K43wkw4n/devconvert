...
import { KnowledgeSection } from "@/components/other/KnowledgeSection";
...
// ── HowToUse component ────────────────────────────────────────────────────────
function HowToUse({ text, howToUseTitle }: { text: string, howToUseTitle: string }) {
  ...
  return (
    ...
    >
      ...
      <ol style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 6 }}>
        {lines.map((line, i) => {
          // Strip leading "N. " from each step
          const content = line.replace(/^\d+\.\s*/, "");
          const isTip = content.toLowerCase().startsWith("tip:") ||
            content.startsWith("เคล็ดลับ:") ||
            content.startsWith("ヒント:") ||
            content.startsWith("提示:");
          ...
          return (
            ...
            >
              ...
              <span>
                {isTip
                  ? content.replace(/^(tip:|เคล็ดลับ:|ヒント:|提示:)\s*/i, "")
                  : content}
              </span>
            </li>
          );
...
export default function ConverterPage() {
  ...
  const { description, longDescription, howToUse } = useConverterLocale(converter);
  ...
  return (
    <>
      ...
      <div className="app-content">
        ...
        {/* ── How to Use ── */}
        {howToUse && <HowToUse text={howToUse} howToUseTitle={t.howToUseTitle} />}
        ...
        <KnowledgeSection
          knowledgeSectionTitle={t.knowledgeSectionTitle}
          knowledgeCards={t.knowledgeCards}
          proTipsTitle={t.proTipsTitle}
          proTips={t.proTips} />
